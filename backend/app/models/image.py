...
class Image(Base):
    ...
    shot_attrs = Column(JSON, default=dict, comment="拍摄设备属性快照")
    ...
    device = relationship("DeviceModel", back_populates="images")

    __table_args__ = (
        UniqueConstraint("scene_id", "device_id", name="uq_scene_device"),
    )
